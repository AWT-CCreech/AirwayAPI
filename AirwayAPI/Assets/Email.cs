...
namespace AirwayAPI.Assets
{
    ...
    {
        public static string EmailTemplate = @"<html xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:o=""urn:schemas-microsoft-com:office:office"" xmlns:w=""urn:schemas-microsoft-com:office:word"" xmlns:m=""http://schemas.microsoft.com/office/2004/12/omml"" xmlns=""http://www.w3.org/TR/REC-html40""><head><META HTTP-EQUIV=""Content-Type"" CONTENT=""text/html; charset=us-ascii""><meta name=Generator content=""Microsoft Word 15 (filtered medium)""><!--[if !mso]>
...
<body lang=EN-US link=blue vlink=purple>
	...
	<div class=WordSection1>
		...
		<span style='color:windowtext;text-decoration:none'>
			<img border=0 width=193 height=103 style='width:2.0104in;height:1.0729in' id=""Picture_x0020_2"" src=""cid:%%IMAGE2%%"" alt=""cid:image002.jpg"">
		</span></a>
		...
		<p class=MsoNormal>
			<a href=""https://www.linkedin.com/company/airway-technologies/"">
				<span style='color:windowtext;text-decoration:none'>
					<img border=0 width=160 height=25 style='width:1.6666in;height:.2604in' id=""Picture_x0020_4"" src=""cid:%%IMAGE4%%"" alt=""cid:image004.png"">
				</span>
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
